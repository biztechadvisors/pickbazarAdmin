...
let matchedDataState: any[] = [];
const setMatchedData = (value: any[]) => {
  matchedDataState = value; 
  localStorage.setItem('matchedData', JSON.stringify(value));
};
...
export const setPermissionsData = (newValue: any[]) => {  
