      ...
      <div className="m-auto flex w-full max-w-5xl flex-col items-center lg:flex-row lg:items-start lg:space-s-8">
        <div className="w-full space-y-6 lg:max-w-2xl">
          ...
          <CustomerGrid
            ...
            label={t('text-customer')}
            count={1}
            showAddCustomerSlider={showAddCustomerSlider}
            handleCloseAddCustomerSlider={handleCloseAddCustomerSlider}
            handleOpenAddCustomerSlider={handleOpenAddCustomerSlider}
            handleSubmitAddCustomerForm={handleSubmitAddCustomerForm}
          />
          <ContactGrid
            className="shadow-700 bg-light p-5 md:p-8"
            //@ts-ignore
