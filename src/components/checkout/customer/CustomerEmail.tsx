...
//   async function fetchEmailSuggestions(inputValue:any) {
//     setLoading(true);
//     try {
//       const response = await userClient.fetchUsers({
//         email: inputValue,
...
//       });
//       const users = response?.data || [];
//       const suggestions:any = users.map((user) => ({
//         value: user.id,
//         type: user.name,
//         label: user.email,
//       }));
...
//   function handleSelectEmail(suggestion:any) {
//     // e.preventDefault();
//     setCustomer({
//       id: suggestion?.value,
...
//   console.log("myEmail", emailSuggestions)
